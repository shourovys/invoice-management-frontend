...
function FormCardWithHeader({
  ...
  return (
    <div className="w-full rounded-md bg-formCardBodyBg overscroll-auto">
      <div className="px-4 py-2 space-y-4 bg-formCardHeaderBg rounded-t-md sm:space-y-0">
      ...
      {twoPart ? (
        ...
        <section className={classNames('space-y-3', padding && 'px-4 py-3')}>{children}</section>
      )}
    </div>
  )
}
