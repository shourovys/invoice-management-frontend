...
const RowsPerPageSelector = ({
  ...
  return (
    <div className="items-center hidden gap-2 md:flex">
      ...
      <h4 className="text-sm whitespace-nowrap">{t`Rows Per Page:`}</h4>
      <Select
        primaryColor="#006A4E"
        ...
        classNames={{
          menuButton: (arg) =>
            classNames(
              'flex items-center justify-between text-sm font-normal bg-white border border-solid border-gray-300 rounded-md focus:text-gray-700',
