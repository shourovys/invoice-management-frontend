  ...
  useEffect(() => {
    if (data) {
      ...
      setFormData({
        ...
        CredentialStat: findSelectOption(credentialTypesOptions, CredentialStat),
  ...
  const { trigger, isMutating } = useSWRMutation(credentialApi.edit(queryId), sendPutRequest, {
    onSuccess: () => {
      ...
      queryPersonId // if person preset in query then navigate to that person info page
        ? navigate(routeProperty.credentialInfo.path(queryId, queryPersonId))
  ...
  const breadcrumbsActionsButtons: IActionsButton[] = [
    ...
    },
    {
      ...
      link: queryPersonId // if person preset in query then
        ? routeProperty.credentialInfo.path(queryId, queryPersonId)
        ...
        pageRoutes={
          queryPersonId
            ? [
                ...
                {
                  href: routeProperty.credentialEdit.path(queryId, queryPersonId),
                  text: t`Edit`,
                },
              ]
            : [
