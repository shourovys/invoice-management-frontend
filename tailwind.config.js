  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        sidebarBtnActiveText: 'var(--light-skin-sidebar-btn-active-text-color)',
        ...
        btnPrimaryBg: 'var(--theme-primary-btn-primary-hover-bg)',
        ...
        paginationActivePageBg: 'var(--pagination-active-page-bg)',
        ...
        topMenuCustomBtnHoverText: 'var(--light-skin-top-menu-custom-btn-hover-text-color)',

        // Custom Color: CSV Button
        csvBtnBg: 'var(--csv-btn-bg)',
        csvBtnText: 'var(--csv-btn-text-color)',

        // Custom Color: Add Button
        applyButtonBg: 'var(--add-button-bg)',
        ...
        cancelButtonText: 'var(--cancel-button-text-color)',
        ...
        mobileMenuBtnActiveText: 'var(--light-skin-mobile-menu-btn-active-text-color)',
